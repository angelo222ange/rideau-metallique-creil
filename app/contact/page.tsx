    ...
    <main>
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 bg-dark overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1] mb-4">{content.hero.title}</h1>
            ...
            <div>
              ...
              <div className="divide-y divide-gray-100">
                <a href={siteConfig.phoneLink} className="flex items-start gap-4 py-6 group">
                  <div className="w-10 h-10 flex items-center justify-center flex-shrink-0" style={{ background: '#E07B39', borderRadius: '2px' }}>
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-heading font-bold text-gray-900 text-lg group-hover:text-secondary-terracotta transition-colors">{siteConfig.phone}</p>
                    <p className="text-secondary-terracotta text-xs font-bold uppercase tracking-wider">24h/24 — 7j/7</p>
                  </div>
                </a>

                <a href={`mailto:${siteConfig.email}`} className="flex items-start gap-4 py-6 group">
                  <div className="w-10 h-10 flex items-center justify-center flex-shrink-0 bg-primary-600" style={{ borderRadius: '2px' }}>
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-4 py-6">
                  <div className="w-10 h-10 flex items-center justify-center flex-shrink-0 border border-gray-200" style={{ borderRadius: '2px' }}>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 max-w-5xl mx-auto">
            {content.confiance.items.map((item, index) => (
              <div key={index} className="bg-secondary-sable p-6 text-center">
                <p className="font-display text-3xl text-gray-900 mb-1">{item.value}</p>
              ...
              <ul className="space-y-3 mt-6">
                {content.engagements.items.map((item, index) => (
                  <li key={index} className="flex items-center gap-3 text-gray-600 text-sm">
                    <svg className="w-4 h-4 text-secondary-terracotta flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="section bg-secondary-sable">
        <div className="container">
          ...
          <div className="overflow-hidden h-[400px]" style={{ borderRadius: '2px' }}>
            <iframe
