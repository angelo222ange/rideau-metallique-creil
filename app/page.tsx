          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-12">
              <a
                ...
                className="inline-flex items-center gap-2 whitespace-nowrap px-6 py-3 bg-white text-gray-900 font-semibold text-sm transition-colors hover:bg-gray-100"
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 whitespace-nowrap px-6 py-3 text-white/80 font-medium text-sm border border-white/20 transition-colors hover:bg-white/10 hover:text-white"
                style={{ borderRadius: '8px' }}
              >
                Devis gratuit
              </Link>
