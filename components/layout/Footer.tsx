        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <div className="w-10 h-1 bg-primary-500 mt-3" style={{ borderRadius: '2px' }} />
            </div>
            ...
            <ul className="space-y-3">
              <li>
                <a href={siteConfig.phoneLink} className="flex items-center gap-3 text-white hover:text-primary-400 transition-colors group">
                  <span className="w-9 h-9 bg-white/10 flex items-center justify-center group-hover:bg-primary-600/20 transition-colors" style={{ borderRadius: '10px' }}>
              ...
              <li>
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-3 text-gray-400 hover:text-primary-400 transition-colors group">
                  <span className="w-9 h-9 bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors" style={{ borderRadius: '10px' }}>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start gap-3 text-gray-400">
                <span className="w-9 h-9 bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5" style={{ borderRadius: '10px' }}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="w-8 h-0.5 bg-primary-500 mb-5" style={{ borderRadius: '1px' }} />
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link href="/zones" className="text-primary-400 text-sm font-semibold hover:text-primary-300 transition-colors inline-flex items-center gap-1">
                  Toutes les zones
