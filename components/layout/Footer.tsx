        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <div className="w-10 h-1 bg-primary-500 rounded-full mt-3" />
            </div>
            ...
            <ul className="space-y-3">
              <li>
                <a href={siteConfig.phoneLink} className="flex items-center gap-3 text-white hover:text-primary-400 transition-colors group">
                  <span className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-primary-600 transition-colors">
              ...
              <li className="flex items-start gap-3 text-gray-400">
                <span className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
